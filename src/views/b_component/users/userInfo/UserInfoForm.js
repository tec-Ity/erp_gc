			...
			<Form onSubmit={handleUpdateUser} noValidate validated={validated}>
				<Form.Row>
					<Form.Group as={Col} controlId="formGridCode">
						...
						<Form.Control
							value={props.userInfo && props.userInfo.code}
							type="text"
							required
					...
					<Form.Group as={Col} controlId="formGridName">
						...
						<Form.Control
							value={props.userInfo && props.userInfo.nome}
							type="text"
							required
							disabled={props.isDisabled}
							onChange={(e) => {
				...
				<Form.Row>
					<Form.Group as={Col} controlId="formGridPhone">
						...
						<InputGroup hasValidation>
							...
							<Form.Control
								value={props.userInfo && props.userInfo.phone}
					...
					<Form.Group as={Col} controlId="formGridRole">
						...
						>
							<option
								value={props.userInfo && props.userInfo.role}
							>
								{props.userInfo &&
