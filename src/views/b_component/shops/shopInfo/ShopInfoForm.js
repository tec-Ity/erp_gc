...
export default function ShopInfoForm(props) {
  ...
  useEffect(() => {
    ...
    getNations();
  }, [props.shopInfo.Cita.Area.Nation._id, props.shopInfo.Cita.Area._id]);
        ...
        <Form.Row>
          <Form.Group as={Col} controlId='formGridNation'>
            ...
            <Form.Control
              ...
              disabled={props.isDisabled}>
              <option
                value={props.shopInfo && props.shopInfo.Cita.Area.Nation._id}>
                {props.shopInfo && props.shopInfo.Cita.Area.Nation.nome}(
                {props.shopInfo && props.shopInfo.Cita.Area.Nation.code})
              </option>
              {props.isDisabled === false &&
                nations?.map((nation) => {
                  return props.shopInfo &&
                    ...
                    String(props.shopInfo.Cita.Area.Nation._id) ===
          ...
          <Form.Group as={Col} controlId='formGridArea'>
            ...
            <Form.Control
              ...
              disabled={props.isDisabled}>
              {dispOrgArea && (
                <option value={props.shopInfo && props.shopInfo.Cita.Area._id}>
                  {props.shopInfo && props.shopInfo.Cita.Area.nome}
                  {"  "}({props.shopInfo && props.shopInfo.Cita.Area.code})
                </option>
              )}
              {areas?.map((area) => {
          ...
          <Form.Group as={Col} controlId='formGridCity'>
            ...
            <Form.Control as='select' required disabled={props.isDisabled}>
              {dispOrgCity && (
                <option value={props.shopInfo && props.shopInfo.Cita._id}>
